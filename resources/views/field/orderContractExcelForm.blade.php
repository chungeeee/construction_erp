<form class="form-horizontal" role="form" name="excel_upload_form" id="excel_upload_form" method="post">
    @csrf
    <input type="hidden" id="order_info_no" name="order_info_no" value="{{ $order_info_no }}">
    <br>
    <div class="col-md-12">
        <div class="card card-outline card-lightblue">        
            <div class="card-header p-1">
                <h3 class="card-title"><i class="fas fa-user m-2" size="9px">계약수량 엑셀업로드</i>
            </div>
...
<script>
    ...
    function saveExcel()
    {
        ...
        $.ajax({
            url:"/field/ordercontractexcelaction",
            type:"POST",
            data:formData,
            processData:false,
            contentType:false,
    ...
    function downSample()
    {
        location.href='/field/ordercontractexcelsample';
    }
